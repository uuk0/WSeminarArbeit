...
\begin{document}
    ...
    Die rationalen Zahlen ($\mathbb{Q}$) wurden zur Vervollständigung der ganzen Zahlen
    ($\mathbb{Z}$) definiert, in der die
    ...
    $\sqrt{2}$ keine rationale Zahl sein.

    \section{Näherung von $\sqrt{2}$}

    Wir können aber klar definieren, welche rationalen Zahlen kleiner und größer als $\sqrt{2}$ sind:
    ...
    (Vgl. Begriffsdefinition im nachfolgendem Teil)
    ...
    Elemente der Potenzmenge der rationalen Zahlen, für die obige Eingenschaften gelten.
    ...
    Zu einer Teilmenge m einer geordneten Menge M, wie sie die rationalen Zahlen darstellt, kann es obere und untere
    Schranken geben.
    ...
    Weiterhin ist das Supremum die kleinste obere Schranke, und das Infinum die größte untere Schranke einer Menge M.
