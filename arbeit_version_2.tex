...
\begin{document}
    ...
    (Vgl. Begriffsdefinition im nachfolgendem Teil) und weder leer noch gleich den rationalen Zahlen selbst ist.
    ...
    sodass der dedekind'sche Schnitt keine `Lücken` hat.
    ...
    also r besitzt keine kleinste rationale Zahl.\footnote{
        Nicht zu verwecheln mit `r ist nach unten unbeschränkt'. Wir finden zwischen allen Elementen
    ...
    Wir wolle eine Funktion definieren, die jeder rationalen Zahlen q einen dedekind'schen Schnitt r zuordnet.
    ...
    % Was ist, wenn eines der Elemente negativ ist?
    ...
    - Alexander Toller, Dennis Chen, Freya Edholm: `Proofs in Competition Math: Vol. 1', Version 1.1,
