...
\begin{document}
    ...
    Dafür unterscheiden wir verschieden Fälle der Vorzeicehn von A, B und C

    \subsubsection{$A, B, C \ge 0$}

    Wir dürfen nun umformen:
    ...
    \subsubsection{$A < 0, B \land c \ge 0$}

    Zunächst können wir aufgrund der Kommutativität von A + B annehmen, dass $A < 0$ ist.
    Für den Fall, dass es B ist, können wir aufgrund der Kommutativität der Addition im folgenden A mit B tauschen.
