...
\begin{document}
    ...
    Wenn c `-1' ist, können wir schrieben:
    \[
        d = -1 * (a * b) = -(a * b) = \{q \in \mathbb{Q} \mspace{4mu} | \mspace{4mu} q + x > 0 \land x \in a * b\} =
    \]
    \[
        = \{q \in \mathbb{Q} \mspace{4mu} | \mspace{4mu} q + x * y > 0 \land x \in a \land y \in b\} =
    \]
    \[
        = \{\}
    \]
