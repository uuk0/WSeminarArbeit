...
\begin{document}
    ...
    Ebenfalls gilt die Umkehrung und die Erweiterung auf Mehrvariablige Funktionen.
    ...
    Somit gibt es zu jeder reellen Zahlen m eine natürliche Zahl n (hier s + 1), die größer als m ist, und
    damit ist $\mathbb{R}$ archimedisch.
